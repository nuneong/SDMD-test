...
export const MockUpload = () => (
  <div className="flex h-full w-full bg-[#1e1e1e] rounded-lg overflow-hidden border border-gray-800">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        ...
        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-[#252525] border border-gray-800 hover:border-gray-700 group cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-medium text-gray-200 truncate w-[3.5rem] lg:w-auto lg:max-w-none">
              brand_guidelines.pdf
            </div>
            <div className="text-[10px] text-gray-500 flex flex-col lg:flex-row lg:gap-1 text-left">
              <span className="text-left">PDF</span>
              <span className="hidden lg:inline">•</span>
              <span className="-mt-[1.5px] lg:mt-0 text-left">2.4 MB</span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-[#252525] border border-gray-800 hover:border-gray-700 group cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[10px] text-gray-500 flex flex-col lg:flex-row lg:gap-1 text-left">
              <span className="text-left">CSV</span>
              <span className="hidden lg:inline">•</span>
              <span className="-mt-[1.5px] lg:mt-0 text-left">850 KB</span>
            </div>
          </div>
          <CheckCircle2 size={14} className="text-purple-400" />
        </div>
        ...
        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-[#252525] border border-gray-800 hover:border-gray-700 group cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-medium text-gray-200 truncate w-[3.5rem] lg:w-auto lg:max-w-none">
              competitor_landing.com
            </div>
            <div className="text-[10px] text-gray-500 flex flex-col lg:flex-row lg:gap-1 text-left">
              <span className="text-left">Web</span>
              <span className="hidden lg:inline">•</span>
              <span className="-mt-[1.5px] lg:mt-0 text-left">Scraped</span>
            </div>
          </div>
          <CheckCircle2 size={14} className="text-purple-400" />
        </div>
        ...
        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-[#252525]/50 border border-transparent group">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-xs font-medium text-gray-400 truncate w-[3.5rem] lg:w-auto lg:max-w-none text-left">
    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-[#1e1e1e] p-6 relative">
      <div className="w-full border-2 border-dashed border-gray-700 rounded-lg flex flex-col items-center justify-center py-8 px-4 hover:border-purple-500/40 hover:bg-gray-800/30 transition-all cursor-pointer group relative overflow-hidden -mt-[50px]">
      ...
      {/* Quick Actions */}
      <div className="absolute bottom-[82px] flex gap-3">
        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-900 rounded-full border border-gray-700 text-xs text-gray-400 hover:text-white hover:border-gray-500 transition-colors shadow-lg">
          <span className="w-4 h-4 flex items-center justify-center rounded-full bg-blue-500/20 text-blue-400 text-[10px] font-bold">
            G
          </span>{" "}
          Drive
        </div>
    ...
    <div className="relative h-full w-full bg-[#0F0F0F] rounded-lg overflow-hidden p-4">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className="w-32 h-32 rounded-full bg-black/80 border border-gray-800 shadow-[0_0_40px_rgba(139,92,246,0.15)] flex items-center justify-center relative">
          ...
          <div
            className="absolute w-40 h-40 border border-gray-800/50 rounded-full animate-spin"
            style={{ animationDuration: "17.5s" }}
          >
      ...
      <div className="absolute top-1/4 left-1/4 animate-pulse">
        <div className="px-3 py-1 bg-gray-900/90 border border-violet-500/30 rounded-full text-xs text-violet-200 shadow-[0_0_15px_rgba(139,92,246,0.1)]">
          Context: Persona
        </div>
        <svg
          className="absolute top-full left-1/2 w-32 h-32 -z-10 stroke-gray-800"
      ...
      >
        <div className="px-3 py-1 bg-gray-900/90 border border-pink-500/30 rounded-full text-xs text-pink-200 shadow-[0_0_15px_rgba(244,114,182,0.1)]">
          Source: PDF Data
        </div>
      </div>
      <div
      ...
      >
        <div className="px-3 py-1 bg-gray-900/90 border border-gray-700 rounded-full text-xs text-gray-300 shadow-lg">
          Tone: Professional
        </div>
      </div>
            ...
            <div
              ...
              ${
                step.status === "completed"
                  ...
                  : step.status === "active"
                  ? "bg-purple-500/10 border-purple-500 text-purple-400 shadow-[0_0_10px_rgba(139,92,246,0.5)]"
...
export const MockResult = () => {
  const [activeTab, setActiveTab] = useState<"owned" | "paid" | "earned">(
    "owned"
  );
    ...
    owned: [
      {
        id: 1,
        type: "Instagram",
        title: "Q2 Product Launch Teaser",
        icon: Instagram,
      ...
      },
      {
        ...
        icon: FileText,
        date: "Generated 1h ago",
      },
      {
        id: 4,
        type: "Email",
        title: "Weekly Newsletter V4",
        icon: Mail,
        date: "Generated 3h ago",
      },
    ],
    paid: [
      {
        id: 1,
        type: "Meta Ads",
        title: "Retargeting Campaign #4",
        icon: Share2,
        date: "Optimized 10m ago",
      },
      {
        id: 2,
        type: "LinkedIn",
        title: "B2B Lead Gen Sponsored",
        icon: Link,
        date: "Pending Review",
      },
      {
    ...
    earned: [
      {
        id: 1,
        type: "Review",
        title: "G2 Crowd Response Draft",
        icon: MessageSquare,
        date: "Suggestion Ready",
      },
      {
        id: 2,
        type: "PR",
        title: "Press Release: Series A",
        icon: FileText,
        date: "Draft V1",
      },
    ],
      ...
      <div className="flex-1 flex flex-col bg-[#1e1e1e]">
        <div className="h-12 border-b border-gray-800 flex items-center justify-between px-4 bg-[#1e1e1e]">
          <span className="text-sm font-medium text-white">
            {tabs.find((t) => t.id === activeTab)?.label} Outputs
          </span>
          <span className="text-[10px] text-gray-500 bg-gray-800 px-2 py-0.5 rounded-full">
            {currentContent.length} items
          </span>
        </div>
        <div className="flex-1 overflow-y-auto p-3 lg:p-3 space-y-1.5 lg:space-y-1.5">
          {currentContent.map((item) => (
            <div
              key={item.id}
              className="bg-[#252525] border border-gray-800 rounded-lg p-2.5 lg:p-2 hover:border-gray-600 transition-colors group cursor-pointer scale-y-90 lg:scale-y-100 origin-top"
            >
              <div className="flex items-start justify-between mb-1.5 lg:mb-1.5">
                <div className="flex items-center gap-1.5 lg:gap-1.5">
                  <div className="p-1 lg:p-1 bg-gray-800 rounded text-gray-300 group-hover:text-purple-400 group-hover:bg-gray-700 transition-colors">
                    <item.icon className="w-3 h-3 lg:w-3 lg:h-3" />
                  </div>
                  <span className="text-[10px] lg:text-[10px] font-semibold text-gray-400">
                    {item.type}
                  </span>
                </div>
                <span className="text-[9px] lg:text-[9px] text-gray-600 font-mono">
                  {item.date}
                </span>
              </div>
              <h4 className="text-xs lg:text-xs font-medium text-gray-200 mb-1.5 lg:mb-1 group-hover:text-purple-400 transition-colors leading-tight text-left">
                {item.title}
              </h4>
              <div className="flex items-center gap-1.5 lg:gap-1.5 mt-1.5 lg:mt-1">
                <div className="h-1 lg:h-1 flex-1 bg-gray-800 rounded overflow-hidden">
                  <div className="h-full bg-gray-600 w-2/3"></div>
                </div>
                <button className="text-[9px] lg:text-[9px] text-purple-400 hover:text-white transition-colors opacity-0 group-hover:opacity-100">
                  View
                </button>
              </div>
            </div>
  ...
  <div className="h-full w-full bg-[#0F0F0F] rounded-lg p-3 sm:p-6 flex flex-col gap-3 sm:gap-6">
    ...
    <div className="grid grid-cols-2 gap-2 sm:gap-4">
      ...
      <div className="bg-gray-900/50 p-2 sm:p-4 rounded-lg border border-gray-800 relative overflow-hidden group">
        ...
        <div className="text-[10px] sm:text-xs text-green-500 mt-0.5 sm:mt-1 flex items-center gap-1">
          <span className="bg-green-500/10 px-1 rounded text-[9px] sm:text-[10px]">
            +12.5%
          </span>{" "}
      ...
      <div className="bg-gray-900/50 p-2 sm:p-4 rounded-lg border border-gray-800 relative overflow-hidden group">
        ...
        <div className="text-[10px] sm:text-xs text-purple-400 mt-0.5 sm:mt-1 flex items-center gap-1">
          <span className="bg-purple-500/10 px-1 rounded text-[9px] sm:text-[10px]">
            Excellent
          </span>{" "}
    ...
    <div className="flex-1 bg-gray-900/30 rounded-lg border border-gray-800 p-2.5 sm:p-4 overflow-hidden flex flex-col min-h-0">
      <div className="flex items-center justify-between mb-2 sm:mb-4">
        ...
        <button className="text-[9px] sm:text-[10px] text-purple-400 hover:text-white transition-colors">
          View All
        </button>
      </div>
      <div className="flex-1 overflow-y-auto pr-1 relative min-h-0">
        {/* Vertical Timeline Line */}
        <div className="absolute left-[10px] sm:left-[11px] top-2 bottom-2 w-0.5 bg-gray-800"></div>
        <div className="space-y-2 sm:space-y-4">
          {workflows.map((wf) => (
            <div
              key={wf.id}
              className="relative flex items-center sm:items-start gap-2 sm:gap-4 group"
            >
              {/* Node Icon */}
              <div
                className={`
                      ...
                      ${
                        wf.status === "done"
                          ...
                          : wf.status === "active"
                          ? "border-purple-500 text-purple-400 shadow-[0_0_10px_rgba(139,92,246,0.5)]"
                ...
                <div className="w-full bg-gray-800 h-1 sm:h-1.5 rounded-full overflow-hidden mt-1 sm:mt-1">
                  <div
                    className={`h-full rounded-full transition-all duration-1000 ${
                      wf.status === "done" ? "bg-green-500" : "bg-purple-500"
                    }`}
